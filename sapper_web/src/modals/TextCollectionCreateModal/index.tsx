...
import {useDispatchCollection} from "../../hooks/collection.ts";

const { Content } = Layout;

interface TextCollectionCreateModalProps {
    knowledge_base_uuid: string;
    visible: boolean;
    onClose: () => void;
}

const TextCollectionCreateModal = ({
                                            knowledge_base_uuid,
                                            visible,
                                            onClose
                                        }: TextCollectionCreateModalProps) => {
            ...
            const results = await Promise.allSettled(
                fileList.map(async (file) => {
                    try {
                        ...
                        await dispatchCollection.addCollection({
                            knowledge_base_uuid,
                            file_url: file.url || '',
            ...
            <Content className="file-upload-content">
                ...
                >
                    ...
                    <p className="ant-upload-hint">
                        上传 PDF、TXT、DOCX、CSV、XLSX、HTML、MD等格式的文件
                    </p>
                </Upload.Dragger>
...
export default TextCollectionCreateModal;