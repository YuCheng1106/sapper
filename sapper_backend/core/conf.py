...
class Settings(BaseSettings):
    ...
    TOKEN_EXPIRE_SECONDS: int = 60 * 60 * 24 * 365  # 1 天
    TOKEN_REFRESH_EXPIRE_SECONDS: int = 60 * 60 * 24 * 365  # 7 天
    TOKEN_REDIS_PREFIX: str = 'sapper:token'
    TOKEN_EXTRA_INFO_REDIS_PREFIX: str = 'sapper:token_extra_info'
    TOKEN_ONLINE_REDIS_PREFIX: str = 'sapper:token_online'
    TOKEN_REFRESH_REDIS_PREFIX: str = 'sapper:refresh_token'
    TOKEN_REQUEST_PATH_EXCLUDE: list[str] = [  # JWT / RBAC 路由白名单
        ...
        f'{FASTAPI_API_V1_PATH}/sapper/sapperchain',
    ]

    # JWT
    JWT_USER_REDIS_PREFIX: str = 'sapper:user'
    ...
    # Cookie
    COOKIE_REFRESH_TOKEN_KEY: str = 'sapper_refresh_token'
    COOKIE_REFRESH_TOKEN_EXPIRE_SECONDS: int = 60 * 60 * 24 * 365  # 7 天
    ...
    # 请求限制配置
    REQUEST_LIMITER_REDIS_PREFIX: str = 'sapper:limiter'
    ...
    DEMO_MODE_EXCLUDE: set[tuple[str, str]] = {
        ...
        ('POST', f'{FASTAPI_API_V1_PATH}/oauth2/jxnu/jxnu-auth'),
    }

    # IP 定位配置
    IP_LOCATION_PARSE: Literal['online', 'offline', 'false'] = 'offline'
    IP_LOCATION_REDIS_PREFIX: str = 'sapper:ip:location'
    ...
    LOG_ACCESS_FILENAME: str = 'sapper_access.log'
    LOG_ERROR_FILENAME: str = 'sapper_error.log'
    ...
    PLUGIN_REDIS_PREFIX: str = 'sapper:plugin'
    ...
    OAUTH2_AI_JXNU_URL: str = ''
    OAUTH2_AI_JXNU_AES_KEY: str = ''
    ROBOT_SERVICE_URL: str = ''
    ROBOT_SERVICE_TOKEN: str = ''
    ROBOT_DEFAULT_ID: str = ''
    # 验证码
    CAPTCHA_LOGIN_REDIS_PREFIX: str = 'sapper:login:captcha'
    ...
    CELERY_BACKEND_REDIS_PREFIX: str = 'sapper:celery:'
    ...
    CODE_GENERATOR_DOWNLOAD_ZIP_FILENAME: str = 'sapper_generator'
