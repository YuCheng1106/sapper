...
from app.admin.schema.user import AuthLoginParam, AuthRegisterParam, RegisterUserParam
    ...
    async def register(
        ...
        async with async_db_session.begin() as db:
            try:
                ...
                email = await user_dao.check_email(db, str(obj.email))
                if email:
                ...
                await redis_client.delete(f'{settings.CAPTCHA_LOGIN_REDIS_PREFIX}:{obj.captcha_id}')
